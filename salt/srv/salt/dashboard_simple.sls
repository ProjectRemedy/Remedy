...
# first we exit if the minion has already been accepted (previous install)
# then we enter the loop that waits for the minion key to exist and the
# accept it (no previous install)
